//Programa original: comunicação MQTT com ESP32
//Autor: Pedro Bertoleti
 
//Programa: Comunicação MQTT com ESP32 e uso do sensor de presença PIR HC-SR501
//Autor: João Kleber 
/* Headers */ 
...
#define TOPICO_SUBSCRIBE "Home_Assistant"   
/* Tópico MQTT para envio de informações do ESP32 para broker MQTT */
#define TOPICO_PUBLISH   "sensor-de-presenca"  
...
*/
#define ID_MQTT  "Projetos_Cliente_MQTT"

//São usados os pinos VN GND D27 da placa ESP-WROOM-32
#define pirPin 27               // Input for HC-S501
...
int pirValue = 0;
// Flag para indicar que uma presença foi detectada
...
void setup() 
{
    ...
    attachInterrupt(pirPin, ISR_0, RISING);
    init_serial();
    init_wifi();
    init_mqtt();
}
...
{   
    ...
    if(pir_presence_flag){
      /* Envia frase ao broker MQTT e reseta a flag de presença*/
      pir_presence_flag = false;
      Serial.printf("%d Presença detectada\n",contador);
      contador ++;
